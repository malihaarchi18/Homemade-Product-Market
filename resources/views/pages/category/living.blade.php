...
@if(session('cart'))
            ...
            {{ session('cart') }}
             ...
             @endif   <div class="breadcrumbs">
      <div class="container">
        <div class="row">
          <div class="col">
            <p class="bread"><span>Category</span> / <span>Home & Living</span></p>
          </div>
        </div>
      </div>
    </div>
...
<div class="breadcrumbs-two">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="breadcrumbs-img" style="background-image: url({{asset('public/img/products/diy.jpg')}}">
            </div>
    ...
    <div class="col-md-8">
      <div class="list-group">
          <a href="#" class="list-group-item list-group-item-action"><h6 style="font size: 10px;"><b>ORDER BY</b></h6></a>
             <a href="{{ route('living1')}}" class="list-group-item list-group-item-action"><input type="checkbox"> <b> Low To High </b> </input></a>
              
              <a href="{{ route('living2')}}" class="list-group-item list-group-item-action"><input type="checkbox"> <b> High To Low </b> </input></a>
...
<div class="col-md-8">
  <div class="widget">
    <h3><b> Home & Living Category </b> </h3>
    <br>
    <div class="row">
       
        
      @foreach ($products as $product)
      @if($product->category_name=='Home & Living')
          <div class="col-md-3">
             <div class="card" >
                  @php $i = 1; @endphp
